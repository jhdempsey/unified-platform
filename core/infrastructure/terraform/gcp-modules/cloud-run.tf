    ...
    spec {
      containers {
        ...
        env {
          ...
          value = "http://${data.kubernetes_service.ml_consumer.status[0].load_balancer[0].ingress[0].ip}:9090/metrics"
        }
